...
filepath = 'C:/Users/AD/OneDrive/Học Kỳ Mới/Đồ Án 2/DO_AN_2/model (1).h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:/Users/AD/OneDrive/Học Kỳ Mới/Đồ Án 2/DO_AN_2/static/upload/', filename)
        file.save(file_path)
